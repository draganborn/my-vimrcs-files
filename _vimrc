...
" -----------------------------------------------------------------------
"or for windows C:\Users\alexz\vimfiles\autoload\plug.vim 
"----------------------------------------------------------------------------
"НАСТРОЙКИ ВНЕШНЕГО ВИДА И БАЗОВЫЕ НАСТРОЙКИ РЕДАКТОРА------------------------
set encoding=utf-8 "из красзябр в Кириллицу
set fileencoding=utf-8 "из краскоябр в Кириллицу
...
" сохранение опций для каждого проекта???
set exrc
set secure
""""""""""""""""""""""""""""""""""""""""""""""""""">>> Активация работы с SQL
...
" compile c++ F8
autocmd vimEnter *.cpp map <F8> :w <CR> :!clear ; g++ -- std=c++17 %; if [ -f a.out ]; then time ./a.out; fi <CR>
...
Plug 'jsborjesson/vim-uppercase-sql' " автоматически КАПСИТ синтаксис для SQL
Plug 'mechatroner/rainbow_csv' " по идее должен подсвечивать синтаксис не синтаксисных текстов
Plug 'sukima/xmledit' " типо XML редактор
Plug 'joereynolds/SQHell.vim' " плагин обёртки для SQL
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""colorschemes "
